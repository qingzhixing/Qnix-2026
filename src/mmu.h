...
// Normal segment
#define SEG(type, base, lim, dpl) (struct segdesc){((lim) >> 12) & 0xffff, (unsigned int)(base) & 0xffff, \
                                                   ((unsigned int)(base) >> 16) & 0xff, type, 1, dpl, 1,  \
                                                   (unsigned int)(lim) >> 28, 0, 0, 1, 1, (unsigned int)(base) >> 24}
#define SEG16(type, base, lim, dpl) (struct segdesc){(lim) & 0xffff, (unsigned int)(base) & 0xffff,        \
                                                     ((unsigned int)(base) >> 16) & 0xff, type, 1, dpl, 1, \
